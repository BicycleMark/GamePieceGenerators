...
function generateMetadata(display) {
  return SharedSettingsManager.generateMetadata(display, 'minesweeper');
}
...
function updateControlsFromSettings(metadata, controls) {
  SharedSettingsManager.updateControlsFromSettings(metadata, controls, 'minesweeper');
}
...
function createSettingsFile(display) {
  return SharedSettingsManager.createSettingsFile(display, 'minesweeper');
}
...
function createDefaultsFile() {
  return SharedSettingsManager.createDefaultsFile('minesweeper');
}
...
function loadSettingsFromFile(file, display, controls) {
  return SharedSettingsManager.loadSettingsFromFile(file, display, controls, 'minesweeper');
}
...
function loadSettingsFromUrl(display, controls) {
  return SharedSettingsManager.loadSettingsFromUrl(display, controls, 'minesweeper');
}
...
function loadSettingsFromLocalStorage(display, controls) {
  return SharedSettingsManager.loadSettingsFromLocalStorage(display, controls, 'minesweeper');
}
...
async function loadSettingsFromServer(url, display, controls) {
  return SharedSettingsManager.loadSettingsFromServer(url, display, controls, 'minesweeper');
}
...
async function initializeSettings(display, controls) {
  try {
    return await SharedSettingsManager.initializeSettings(display, controls, 'minesweeper');
  } catch (error) {
